...
import { ArrowLeft, FileText, Shield, type LucideIcon } from 'lucide-react'
...
export default function TermsOfServicePage() {
  const { hero, intro, sections, contact, footerLink } = termsContent
  const HeroIcon = iconMap[hero.icon] ?? FileText
